...
import com.qiwuzhi.mylibrary.base.BaseConfig
import java.io.File
...
class PhotoUtil {
    companion object {
        ...
        private val authorities = BaseConfig.FILE_PROVIDER
...
private fun getPhotoFragment(manager: FragmentManager) =
    manager.findFragmentByTag("photoFragmen") as? PhotoUtil.PhotoFragment
        ?: PhotoUtil.PhotoFragment().apply {
